    ...
    <div className="bg-[#e1e7d9] py-8 sm:py-12 lg:py-16">
      <div className="container mx-auto px-4 sm:px-12">
        ...
        <div className="flex flex-col gap-12">
          <h2 className="pb-2 text-center font-heading text-4xl font-bold text-[#122134] sm:text-5xl">
            Two Pathways, One Cohort
          </h2>

          <p className="max-w-3xl text-2xl font-semibold leading-[46px] text-[#122134] sm:text-3xl">
          ...
          {/* Pathway cards — side by side on desktop */}
